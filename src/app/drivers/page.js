...
<ProgressLine name={step} percent={progress} Color={`#2563eb`} stat={`% Complete`}></ProgressLine>
    <div className={`flex flex-col justify-between mt-3 md:flex-row`}>
        ...
        <ProfileCard title={`License & Medical`} desc={`Driving credentials and health records`} stat={step==4} icon={<FileText></FileText>}></ProfileCard>
        <ProfileCard title={`Training & Certifications`} desc={`Professional development and qualifications`} stat={step==5} icon={<Award></Award>}></ProfileCard>
       ...
       <DriverForm UpdateProgress={updateProgress} UpdateStep={setStep}></DriverForm>
