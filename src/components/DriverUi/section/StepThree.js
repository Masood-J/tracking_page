           ...
           focus:ring-1 focus:ring-blue-400 focus:shadow hover:border-gray-400 ${errors.Department?"border-red-500":""}`}></Field>
                ...
                <div className={`flex flex-row flex-wrap gap-2 justify-between w-full text-black`}>
                    <div className={`flex-1`}>
                        ...
                        <Field name="Location" type="text" className="border min-w-30 border-gray-300 p-2 w-full rounded-xl focus:outline-none focus:border-blue-500
           focus:ring-1 focus:ring-blue-400 focus:shadow hover:border-gray-400"></Field>
                ...
                <div className={`flex flex-row flex-wrap gap-2 justify-between w-full text-black`}>
                    <div className={`flex-1`}>
                        ...
                        <Field name="Salary" type="text" className="border min-w-30 border-gray-300 p-2 w-full rounded-xl focus:outline-none focus:border-blue-500
           focus:ring-1 focus:ring-blue-400 focus:shadow hover:border-gray-400"></Field>
