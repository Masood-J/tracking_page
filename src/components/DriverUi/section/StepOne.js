...
<div className={`flex-1`}>
    ...
    <div className={`flex flex-row gap-2 justify-between w-full text-black`}>
        ...
        <div className={`flex-1`}>
            ...
            <Field name="DOB" type="date" className="border border-gray-300 p-2 w-full rounded-xl"></Field>
    ...
    <div className={`flex flex-row gap-2 justify-between w-full text-black`}>
        ...
        <div className={`flex-1`}>
            <label htmlFor="gender" className={`block`}>Date of Birth:</label>
    ...
    <div className={`flex flex-row gap-2 justify-between w-full text-black`}>
        <div className={`flex-1`}>
            <label htmlFor="National" className={`block`}>Nationality:</label>
